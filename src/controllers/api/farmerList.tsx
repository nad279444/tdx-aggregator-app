import { FARMERLIST, FINDFARMER } from "../../constants/Constants";
...
export const farmers = {
    ...
    getOne: async (find) => {
        try {
            ...
            const response = await axios.post(`${FINDFARMER}/${user_token}`, {
                find,
            }, {
                headers: {
                    Authorization: `Bearer ${access_token}`,
            ...
            console.error(`Failed to fetch farmer with mobile number ${find}:`, error.message);
            throw error;
        }
    }
};
