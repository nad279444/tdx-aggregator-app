      ...
      if (isConnected) {
        try {
          ...
          const timeout = new Promise((_, reject) =>
            setTimeout(() => reject(new Error("Network timed out")), 10000)
          );
          const syncOperation = await orderstats.fetchAndSync();
    ...
    <View style={styles.container}>
      ...
      {activeTab === "progress" && (
        <View style={styles.buttonGroup}>
          ...
          >
            <Text
              style={{ color: activeChart === "weekly" ? "white" : "black" }}
            >
              Weekly
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text
              style={{ color: activeChart === "yearly" ? "white" : "black" }}
            >
              Yearly
            </Text>
          </TouchableOpacity>
